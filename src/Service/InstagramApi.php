...
class InstagramApi 
{
	...
	public function __construct(SessionInterface $session){
		...
		$this->clientID = '1bd3c2a52e064b4f83d29080d5803e70';
		$this->clientSecret = '6d4c11a550ff42499e7adee0ef985da5';
		$this->redirectURI = 'http://127.0.0.1:8000/api/instagram_callback';
	...
	public function storeSession($array){
		
		$this->session->set('access_token', $array['access_token']);
		$this->session->set('id', $array['user']['id']);
		$this->session->set('username', $array['user']['username']);
		$this->session->set('full_name', $array['user']['full_name']);
		$this->session->set('bio', $array['user']['bio']);
		$this->session->set('website', $array['user']['website']);
		$this->session->set('profile_picture', $array['user']['profile_picture']);
	}
